...
export const DEFAULT_OPTIONS = {
  matchMinutes: 0,         // duración del partido en minutos (0 = ilimitado)
  goalsToWin: 0,           // goles para ganar (0 = ilimitado)
  ...
  infiniteBoost: false,    // boolean: boost infinito en coches (default false)
};
